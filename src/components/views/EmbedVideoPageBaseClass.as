...
public class EmbedVideoPageBaseClass extends TitleWindow
{
	...
	public var embed_btn:Button;
	private const kernelUrl:String = "http://widgets.clearspring.com/o/4a6b20041d9f3802/4a6b20041d9f3802/-/-TRK/1/lib.v3.as3.swf";
	...
	embed_btn.addEventListener(MouseEvent.CLICK,on_share_click);
	...
	private function onApiLoad(e:Event):void
	{
		...
		// kernel.widget.update(YOUR-USER-ID, '4a6dbba391bbadec', {content: '<h1>insert your own content</h1>'});
		...
		private function on_share_click(event:MouseEvent):void
		{
		kernel.menu.show();
